...
function deserializeToTime(value) {
    ...
    const { hours, minutes, seconds } = (regexResult === null || regexResult === void 0 ? void 0 : regexResult.groups) || {};
    return {
...
function deserializeToMoment(edmDateTime) {
    var _a;
    const dateTimeOffsetComponents = (_a = /^\/Date\((?<signedticks>-{0,1}\d+)((?<offsetsign>[+-])(?<unsignedoffset>\d{4}))?\)\/$/.exec(edmDateTime)) === null || _a === void 0 ? void 0 : _a.groups;
