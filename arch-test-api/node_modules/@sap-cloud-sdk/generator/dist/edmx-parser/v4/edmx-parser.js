...
function parseOperationImports(root, operationType) {
    const operationImports = (0, edmx_parser_1.getPropertyFromEntityContainer)(root, `${voca_1.default.capitalize(operationType)}Import`);
    return operationImports.map(operationImport => ({
        ...operationImport,
        operationName: operationImport[voca_1.default.capitalize(operationType)],
        operationType
    }));
}
 ...
 * @internal
 */
function parseOperations(root, operationType) {
    return (0, edmx_parser_1.getMergedPropertyWithNamespace)(root, voca_1.default.capitalize(operationType)).map(operation => ({
        ...operation,
