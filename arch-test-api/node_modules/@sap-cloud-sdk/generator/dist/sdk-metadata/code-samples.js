...
exports.actionImportCodeSample = exports.functionImportCodeSample = exports.entityCodeSample = void 0;
 ...
 * @internal
 */
function entityCodeSample(entityName, serviceName, directoryName) {
    return (0, util_1.codeBlock) `
import { ${voca_1.default.decapitalize(serviceName)} } from './generated/${directoryName}';
...
function getParameterCodeSample(functionImport) {
    if (functionImport.parameters) {
        return `const parameter: ${functionImport.parametersTypeName} = ${(0, code_sample_util_1.getOperationParams)(functionImport.parameters)};
    `;
    }
    return '';
}
