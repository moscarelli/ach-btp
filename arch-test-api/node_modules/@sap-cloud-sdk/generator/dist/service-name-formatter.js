...
class ServiceNameFormatter {
    ...
    static directoryToSpeakingModuleName(packageName) {
        return voca_1.default.titleCase(packageName.replace(/-/g, ' '));
    }
    constructor(entitySetNames = [], complexTypeNames = [], functionImportNames = []) {
    ...
    originalToOperationName(originalName) {
        const transformedName = voca_1.default.camelCase(originalName);
    ...
    originalToBoundOperationName(entityName, functionName) {
        const generator = this.getOrInitGenerator(this.instancePropertyNameGenerators, entityName);
        const transformedName = voca_1.default.camelCase(functionName);
    ...
    originalToComplexTypeName(originalName) {
        ...
        return this.serviceWideNameGenerator.generateAndSaveUniqueName(transformedName, false);
    }
    ...
    originalToEntityClassName(entitySetName) {
        ...
        const newNames = this.serviceWideNameGenerator.generateAndSaveUniqueNamesWithSuffixes(transformedName, getInterfaceNamesSuffixes(), false);
        return newNames[0];
    }
