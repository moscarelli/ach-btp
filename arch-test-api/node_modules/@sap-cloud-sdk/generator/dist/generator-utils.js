 ...
 * @internal
 */
function npmCompliantName(name) {
...
const transformIfNecessary = (packageName) => {
...
const stripLeadingDotsAndUnderscores = (str) => str.replace(/^[._]*/g, '');
const replaceNonNpmPackageCharacters = (str) => str.replace(/[^a-z0-9-~._]/g, '');
const makeNpmCompliant = (name) => {
...
function hasEntities(service) {
    var _a;
    return !!((_a = service.entities) === null || _a === void 0 ? void 0 : _a.length);
}
