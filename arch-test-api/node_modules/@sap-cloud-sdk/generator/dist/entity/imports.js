...
function entityImportDeclarations(entity, service, oDataVersion) {
    if (oDataVersion === 'v4') {
        return (0, imports_1.mergeImportDeclarations)([
            (0, imports_1.odataImportDeclaration)(['Entity', 'DefaultDeSerializers', 'DeSerializers', 'DeserializedType'], oDataVersion),
            ...
            ...(0, operations_1.operationImportDeclarations)(service, 'action', entity.actions),
            ...(0, operations_1.operationImportDeclarations)(service, 'function', entity.functions),
