...
import { VdmNavigationProperty, VdmProperty, VdmServiceMetadata } from './vdm-types';
/**
 ...
 * @internal
 */
export declare function isDeletable(entity: any): boolean;
/**
 ...
 * @internal
 */
export declare function isUpdatable(entity: any): boolean;
/**
 ...
 * @internal
 */
export declare function isCreatable(entity: any): boolean;
/**
 ...
 * @internal
 */
export declare function isSortable(property: any): boolean;
/**
 ...
 * @internal
 */
export declare function isFilterable(property: any): boolean;
/**
 ...
 * @internal
 */
export declare function isNullableProperty(property: any): boolean;
/**
 * Checks if the 'Nullable' property is present on the given input.
 ...
 * @internal
 */
export declare function isNullableParameter(parameter: any): boolean;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare function getFallbackEdmTypeIfNeeded(edmType: string): EdmTypeShared;
/**
 * @internal
 */
export declare function edmToTsType(edmType: string): string;
/**
 * @internal
 */
export declare function edmToFieldType(edmType: string): string;
/**
 * @internal
 */
export declare function edmToComplexPropertyType(edmType: string): string;
/**
 * @internal
 */
export declare function forceArray(obj: any): any[];
/**
 * @internal
 */
 ...
 * @internal
 */
export declare function endWithDot(text: string): string;
/**
 * @internal
 */
export declare function linkClass(navProperty: VdmNavigationProperty, oDataVersion: ODataVersion): string;
/**
 * @internal
 */
export declare function getGenericParameters(entityClassName: string, prop: VdmProperty, isSelectable: boolean): string;
/**
 ...
 * @internal
 */
export declare function prefixString(string: string, prefix?: string): string;
/**
 ...
 * @internal
 */
export declare function npmCompliantName(name: string): string;
/**
 * @internal
 */
export declare function cloudSdkVdmHack(name: string): string;
/**
 * @internal
 */
export declare function hasEntities(service: VdmServiceMetadata): boolean;
/**
 * @internal
 * This is copied from the `@sap-cloud-sdk/odata-common`
 */
export type EdmTypeShared = 'Edm.String' | 'Edm.Boolean' | 'Edm.Decimal' | 'Edm.Double' | 'Edm.Single' | 'Edm.Float' | 'Edm.Int16' | 'Edm.Int32' | 'Edm.Int64' | 'Edm.SByte' | 'Edm.Binary' | 'Edm.Guid' | 'Edm.Byte' | 'Edm.Any' | 'Edm.DateTimeOffset' | 'Edm.DateTime' | 'Edm.Time' | 'Edm.Date' | 'Edm.Duration' | 'Edm.TimeOfDay' | 'Edm.Enum';
