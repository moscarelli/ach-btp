 ...
 * @internal
 */
export declare function generateUnboundOperations(serviceMetadata: ServiceMetadata, serviceName: string, operationType: 'function' | 'action', entities: VdmPartialEntity[], complexTypes: VdmComplexType[], formatter: ServiceNameFormatter): VdmOperation[];
/**
 * @internal
 */
export declare function generateBoundOperations(serviceMetadata: ServiceMetadata, serviceName: string, operationType: 'function' | 'action', entities: VdmPartialEntity[], complexTypes: VdmComplexType[], formatter: ServiceNameFormatter, edmxBindingEntitySetName: string, bindingEntityClassName: string): VdmOperation[];
