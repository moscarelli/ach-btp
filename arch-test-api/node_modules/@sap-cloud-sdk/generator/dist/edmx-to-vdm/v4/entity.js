...
function generateEntitiesV4(serviceMetadata, complexTypes, enumTypes, formatter) {
    ...
    return entitiesMetadata.map(entityMetadata => ({
        ...
        functions: (0, operation_1.generateBoundOperations)(serviceMetadata, entityMetadata.entityType.Namespace, 'function', entities, complexTypes, formatter, entityMetadata.entitySet.Name, classNames[entityMetadata.entitySet.Name]),
        actions: (0, operation_1.generateBoundOperations)(serviceMetadata, entityMetadata.entityType.Namespace, 'action', entities, complexTypes, formatter, entityMetadata.entitySet.Name, classNames[entityMetadata.entitySet.Name])
    }));
}
