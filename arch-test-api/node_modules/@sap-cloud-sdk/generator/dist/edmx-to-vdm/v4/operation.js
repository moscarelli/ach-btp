 ...
 * @internal
 */
function generateUnboundOperations(serviceMetadata, serviceName, operationType, entities, complexTypes, formatter) {
    return generateOperations(serviceMetadata, serviceName, operationType, entities, complexTypes, formatter);
}
exports.generateUnboundOperations = generateUnboundOperations;
/**
 * @internal
 */
function generateBoundOperations(serviceMetadata, serviceName, operationType, entities, complexTypes, formatter, edmxBindingEntitySetName, bindingEntityClassName) {
    return generateOperations(serviceMetadata, serviceName, operationType, entities, complexTypes, formatter, edmxBindingEntitySetName, bindingEntityClassName);
}
exports.generateBoundOperations = generateBoundOperations;
/**
 * @internal
 */
function generateOperations(serviceMetadata, serviceName, operationType, entities, complexTypes, formatter, edmxBindingEntitySetName, className) {
    const operations = (0, edmx_parser_1.parseOperations)(serviceMetadata.edmx.root, operationType);
    const operationImports = (0, edmx_parser_1.parseOperationImports)(serviceMetadata.edmx.root, operationType);
