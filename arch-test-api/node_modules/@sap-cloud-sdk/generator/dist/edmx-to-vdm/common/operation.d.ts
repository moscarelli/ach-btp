 ...
 */
export declare function transformOperationBase(edmxOperation: EdmxFunctionImportV2 | EdmxJoinedOperation, edmxParameters: EdmxParameter[], type: 'function' | 'action', swaggerDefinition: SwaggerPath | undefined, formatter: ServiceNameFormatter, edmxBindingEntitySetName?: string): VdmOperationBase;
