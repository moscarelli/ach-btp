...
class FunctionImportRequestBuilder extends internal_1.ActionFunctionImportRequestBuilderBase {
     ...
     */
    constructor(defaultServicePath, functionImportName, responseTransformer, parameters, deSerializers) {
        super(responseTransformer, new request_1.ODataFunctionImportRequestConfig('get', defaultServicePath, functionImportName, parameters, (0, uri_conversion_1.createODataUri)(deSerializers)));
