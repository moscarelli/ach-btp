...
function getExpandAsString(expand, entityApi) {
    ...
    if (expand instanceof internal_1.Link) {
        ...
        if (expand instanceof internal_1.OneToManyLink) {
            params = {
                ...params,
                ...(0, internal_1.createGetFilter)(uri_value_converter_1.uriConverter).getFilter((0, internal_1.and)(((_a = expand._filters) === null || _a === void 0 ? void 0 : _a.filters) || []), entityApi),
