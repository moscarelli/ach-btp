...
class ODataRequest {
     ...
     */
    relativeUrl(includeServicePath = true, includeQueryParameters = true) {
        const query = includeQueryParameters ? this.query() : '';
        return `${(0, util_1.removeTrailingSlashes)(this.relativeResourceUrl(includeServicePath))}${this.config.appendedPaths.join('')}${query}`;
    }
    /**
    ...
    serviceUrl() {
        ...
        const servicePath = typeof this.config.customServicePath === 'undefined'
            ? this.config.defaultServicePath
            : this.config.customServicePath;
        return `${(0, util_1.removeTrailingSlashes)(systemUrl)}/${(0, util_1.removeSlashes)(servicePath)}`;
    }
    /**
    ...
    relativeServiceUrl() {
        const servicePath = typeof this.config.customServicePath === 'undefined'
            ? this.config.defaultServicePath
            : this.config.customServicePath;
        return `${(0, util_1.removeSlashes)(servicePath)}`;
    }
    /**
     ...
     */
    relativeResourceUrl(includeServicePath = true) {
    ...
    async execute() {
        ...
        return (0, http_client_1.executeHttpRequest)(destination, await this.requestConfig(), {
    ...
    getAdditionalHeadersForKeys(...keys) {
        var _a;
        const destinationHeaders = (0, util_1.pickIgnoreCase)((_a = this.destination) === null || _a === void 0 ? void 0 : _a.headers, ...keys);
