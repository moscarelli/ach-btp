...
const odata_delete_request_config_1 = require("../request/odata-delete-request-config");
...
class DeleteRequestBuilderBase extends request_builder_base_1.MethodRequestBuilder {
    ...
    constructor(_entityApi, oDataUri, keysOrEntity) {
        super(new odata_delete_request_config_1.ODataDeleteRequestConfig(_entityApi, oDataUri));
