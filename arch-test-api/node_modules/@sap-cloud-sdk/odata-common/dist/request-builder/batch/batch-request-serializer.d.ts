 ...
 * @internal
 */
export declare function serializeRequest<EntityT extends EntityBase, DeSerializersT extends DeSerializers, ReturnT, ParametersT>(request: AllRequestBuilders<EntityT, DeSerializersT>, options?: BatchRequestSerializationOptions): string;
type RequestBuildersWithBatchReference = Omit<MethodRequestBuilder, 'execute'> & WithBatchReference;
type AllRequestBuilders<EntityT extends EntityBase, DeSerializersT extends DeSerializers> = RequestBuildersWithBatchReference | Omit<MethodRequestBuilder, 'execute'>;
/**
