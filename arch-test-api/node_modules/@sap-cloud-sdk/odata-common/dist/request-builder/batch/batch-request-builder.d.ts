...
export declare class BatchRequestBuilder<DeSerializersT extends DeSerializers = DefaultDeSerializers> extends MethodRequestBuilder<ODataBatchRequestConfig> {
    ...
    readonly requests: (BatchChangeSet<DeSerializersT> | GetAllRequestBuilderBase<EntityBase, DeSerializersT> | GetByKeyRequestBuilderBase<EntityBase, DeSerializersT> | Omit<ActionFunctionImportRequestBuilderBase<unknown, ODataRequestConfig>, 'execute'>)[];
     ...
     */
    constructor(defaultServicePath: string, requests: (BatchChangeSet<DeSerializersT> | GetAllRequestBuilderBase<EntityBase, DeSerializersT> | GetByKeyRequestBuilderBase<EntityBase, DeSerializersT> | Omit<ActionFunctionImportRequestBuilderBase<unknown, ODataRequestConfig>, 'execute'>)[]);
