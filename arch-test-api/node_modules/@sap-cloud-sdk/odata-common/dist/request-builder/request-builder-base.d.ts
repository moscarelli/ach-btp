...
export declare abstract class MethodRequestBuilder<RequestConfigT extends ODataRequestConfig = any> {
     ...
     */
    url(destination: DestinationOrFetchOptions): Promise<string>;
    /**
     ...
     * @returns The request builder itself, to facilitate method chaining.
     * @deprecated Since v2.13.0. The timeout configuration is replaced by the more general {@link https://sap.github.io/cloud-sdk/docs/js/guides/resilience middleware approach} in version 3.0 of the SAP Cloud SDK.
     */
    ...
    protected build(destination: DestinationOrFetchOptions): Promise<ODataRequest<RequestConfigT>>;
}
