 ...
 * @internal
 */
function getEntityKeys(entity, entityApi) {
    if (!entity) {
        throw new Error('getEntityKeys() cannot extract keys from an undefined or null object.');
    }
    return entityApi.entityConstructor._keys.reduce((prev, curr) => ({
        ...prev,
        [curr]: encodeURIComponent(entity[(0, util_1.camelCase)(curr)])
    }), {});
}
