...
class CustAddrDepdntExtIdentifierApi {
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = Object.assign(Object.assign({ CUSTOMER: fieldBuilder.buildEdmTypeField('Customer', 'Edm.String', false), ADDRESS_ID: fieldBuilder.buildEdmTypeField('AddressID', 'Edm.String', false), CUSTOMER_EXTERNAL_REF_ID: fieldBuilder.buildEdmTypeField('CustomerExternalRefID', 'Edm.String', true) }, this.navigationPropertyFields), { ALL_FIELDS: new odata_v2_1.AllFields('*', CustAddrDepdntExtIdentifier_1.CustAddrDepdntExtIdentifier) });
        }
        return this._schema;
    }
}
