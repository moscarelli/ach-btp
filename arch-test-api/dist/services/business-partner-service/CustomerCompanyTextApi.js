...
class CustomerCompanyTextApi {
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = Object.assign(Object.assign({ CUSTOMER: fieldBuilder.buildEdmTypeField('Customer', 'Edm.String', false), COMPANY_CODE: fieldBuilder.buildEdmTypeField('CompanyCode', 'Edm.String', false), LANGUAGE: fieldBuilder.buildEdmTypeField('Language', 'Edm.String', false), LONG_TEXT_ID: fieldBuilder.buildEdmTypeField('LongTextID', 'Edm.String', false), LONG_TEXT: fieldBuilder.buildEdmTypeField('LongText', 'Edm.String', true) }, this.navigationPropertyFields), { ALL_FIELDS: new odata_v2_1.AllFields('*', CustomerCompanyText_1.CustomerCompanyText) });
        }
        return this._schema;
    }
}
