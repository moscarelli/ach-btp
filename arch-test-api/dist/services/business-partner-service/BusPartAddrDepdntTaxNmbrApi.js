...
class BusPartAddrDepdntTaxNmbrApi {
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = Object.assign(Object.assign({ BUSINESS_PARTNER: fieldBuilder.buildEdmTypeField('BusinessPartner', 'Edm.String', false), ADDRESS_ID: fieldBuilder.buildEdmTypeField('AddressID', 'Edm.String', false), BP_TAX_TYPE: fieldBuilder.buildEdmTypeField('BPTaxType', 'Edm.String', false), BP_TAX_NUMBER: fieldBuilder.buildEdmTypeField('BPTaxNumber', 'Edm.String', true), BP_TAX_LONG_NUMBER: fieldBuilder.buildEdmTypeField('BPTaxLongNumber', 'Edm.String', true), AUTHORIZATION_GROUP: fieldBuilder.buildEdmTypeField('AuthorizationGroup', 'Edm.String', true) }, this.navigationPropertyFields), { ALL_FIELDS: new odata_v2_1.AllFields('*', BusPartAddrDepdntTaxNmbr_1.BusPartAddrDepdntTaxNmbr) });
        }
        return this._schema;
    }
}
