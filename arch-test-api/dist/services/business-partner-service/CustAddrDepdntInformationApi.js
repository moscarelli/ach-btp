...
class CustAddrDepdntInformationApi {
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = Object.assign(Object.assign({ CUSTOMER: fieldBuilder.buildEdmTypeField('Customer', 'Edm.String', false), ADDRESS_ID: fieldBuilder.buildEdmTypeField('AddressID', 'Edm.String', false), EXPRESS_TRAIN_STATION_NAME: fieldBuilder.buildEdmTypeField('ExpressTrainStationName', 'Edm.String', true), TRAIN_STATION_NAME: fieldBuilder.buildEdmTypeField('TrainStationName', 'Edm.String', true), CITY_CODE: fieldBuilder.buildEdmTypeField('CityCode', 'Edm.String', true), COUNTY: fieldBuilder.buildEdmTypeField('County', 'Edm.String', true) }, this.navigationPropertyFields), { ALL_FIELDS: new odata_v2_1.AllFields('*', CustAddrDepdntInformation_1.CustAddrDepdntInformation) });
        }
        return this._schema;
    }
}
