...
class BusinessPartnerRoleApi {
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = Object.assign(Object.assign({ BUSINESS_PARTNER: fieldBuilder.buildEdmTypeField('BusinessPartner', 'Edm.String', false), BUSINESS_PARTNER_ROLE: fieldBuilder.buildEdmTypeField('BusinessPartnerRole', 'Edm.String', false), VALID_FROM: fieldBuilder.buildEdmTypeField('ValidFrom', 'Edm.DateTimeOffset', true), VALID_TO: fieldBuilder.buildEdmTypeField('ValidTo', 'Edm.DateTimeOffset', true), AUTHORIZATION_GROUP: fieldBuilder.buildEdmTypeField('AuthorizationGroup', 'Edm.String', true) }, this.navigationPropertyFields), { ALL_FIELDS: new odata_v2_1.AllFields('*', BusinessPartnerRole_1.BusinessPartnerRole) });
        }
        return this._schema;
    }
}
