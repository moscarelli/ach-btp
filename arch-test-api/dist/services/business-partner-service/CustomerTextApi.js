...
class CustomerTextApi {
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = Object.assign(Object.assign({ CUSTOMER: fieldBuilder.buildEdmTypeField('Customer', 'Edm.String', false), LANGUAGE: fieldBuilder.buildEdmTypeField('Language', 'Edm.String', false), LONG_TEXT_ID: fieldBuilder.buildEdmTypeField('LongTextID', 'Edm.String', false), LONG_TEXT: fieldBuilder.buildEdmTypeField('LongText', 'Edm.String', true) }, this.navigationPropertyFields), { ALL_FIELDS: new odata_v2_1.AllFields('*', CustomerText_1.CustomerText) });
        }
        return this._schema;
    }
}
