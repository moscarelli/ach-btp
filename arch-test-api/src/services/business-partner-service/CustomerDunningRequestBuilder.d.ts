 ...
 */
export declare class CustomerDunningRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<CustomerDunning<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<CustomerDunning<T>, T>;
  /**
   ...
   */
  create(
    entity: CustomerDunning<T>
  ): CreateRequestBuilder<CustomerDunning<T>, T>;
  /**
  ...
  update(
    entity: CustomerDunning<T>
  ): UpdateRequestBuilder<CustomerDunning<T>, T>;
  /**
  ...
  delete(
    ...
    companyCode: string,
    dunningArea: string
  ): DeleteRequestBuilder<CustomerDunning<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `CustomerDunning`.
