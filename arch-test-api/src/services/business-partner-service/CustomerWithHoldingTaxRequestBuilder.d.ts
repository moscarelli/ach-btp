 ...
 */
export declare class CustomerWithHoldingTaxRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<CustomerWithHoldingTax<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<CustomerWithHoldingTax<T>, T>;
  /**
   ...
   */
  create(
    entity: CustomerWithHoldingTax<T>
  ): CreateRequestBuilder<CustomerWithHoldingTax<T>, T>;
  /**
  ...
  update(
    entity: CustomerWithHoldingTax<T>
  ): UpdateRequestBuilder<CustomerWithHoldingTax<T>, T>;
  /**
  ...
  ): DeleteRequestBuilder<CustomerWithHoldingTax<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `CustomerWithHoldingTax`.
