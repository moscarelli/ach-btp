 ...
 */
export declare class BusinessPartnerTaxNumberRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<BusinessPartnerTaxNumber<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<BusinessPartnerTaxNumber<T>, T>;
  /**
   ...
   */
  create(
    entity: BusinessPartnerTaxNumber<T>
  ): CreateRequestBuilder<BusinessPartnerTaxNumber<T>, T>;
  /**
  ...
  update(
    entity: BusinessPartnerTaxNumber<T>
  ): UpdateRequestBuilder<BusinessPartnerTaxNumber<T>, T>;
  /**
  ...
  delete(
    ...
    bpTaxType: string
  ): DeleteRequestBuilder<BusinessPartnerTaxNumber<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `BusinessPartnerTaxNumber`.
