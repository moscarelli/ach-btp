 ...
 */
export declare class CustomerCompanyRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<CustomerCompany<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<CustomerCompany<T>, T>;
  /**
   ...
   */
  create(
    entity: CustomerCompany<T>
  ): CreateRequestBuilder<CustomerCompany<T>, T>;
  /**
  ...
  update(
    entity: CustomerCompany<T>
  ): UpdateRequestBuilder<CustomerCompany<T>, T>;
}
