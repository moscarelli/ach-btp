 ...
 */
export declare class AddressPhoneNumberRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<AddressPhoneNumber<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<AddressPhoneNumber<T>, T>;
  /**
   ...
   */
  create(
    entity: AddressPhoneNumber<T>
  ): CreateRequestBuilder<AddressPhoneNumber<T>, T>;
  /**
  ...
  update(
    entity: AddressPhoneNumber<T>
  ): UpdateRequestBuilder<AddressPhoneNumber<T>, T>;
  /**
  ...
  ): DeleteRequestBuilder<AddressPhoneNumber<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `AddressPhoneNumber`.
