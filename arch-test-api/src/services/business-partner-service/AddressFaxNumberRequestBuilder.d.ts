 ...
 */
export declare class AddressFaxNumberRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<AddressFaxNumber<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<AddressFaxNumber<T>, T>;
  /**
   ...
   */
  create(
    entity: AddressFaxNumber<T>
  ): CreateRequestBuilder<AddressFaxNumber<T>, T>;
  /**
  ...
  update(
    entity: AddressFaxNumber<T>
  ): UpdateRequestBuilder<AddressFaxNumber<T>, T>;
  /**
  ...
  ): DeleteRequestBuilder<AddressFaxNumber<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `AddressFaxNumber`.
