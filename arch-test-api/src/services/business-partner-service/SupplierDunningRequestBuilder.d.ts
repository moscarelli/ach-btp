 ...
 */
export declare class SupplierDunningRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<SupplierDunning<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<SupplierDunning<T>, T>;
  /**
   ...
   */
  create(
    entity: SupplierDunning<T>
  ): CreateRequestBuilder<SupplierDunning<T>, T>;
  /**
  ...
  update(
    entity: SupplierDunning<T>
  ): UpdateRequestBuilder<SupplierDunning<T>, T>;
  /**
  ...
  delete(
    ...
    companyCode: string,
    dunningArea: string
  ): DeleteRequestBuilder<SupplierDunning<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `SupplierDunning`.
