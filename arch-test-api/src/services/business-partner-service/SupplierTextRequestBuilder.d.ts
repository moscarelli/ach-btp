 ...
 */
export declare class SupplierTextRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<SupplierText<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<SupplierText<T>, T>;
  /**
  ...
  delete(
    ...
    language: string,
    longTextId: string
  ): DeleteRequestBuilder<SupplierText<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `SupplierText`.
