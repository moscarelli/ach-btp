 ...
 */
export declare class BusinessPartnerRoleRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<BusinessPartnerRole<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<BusinessPartnerRole<T>, T>;
  /**
   ...
   */
  create(
    entity: BusinessPartnerRole<T>
  ): CreateRequestBuilder<BusinessPartnerRole<T>, T>;
  /**
  ...
  update(
    entity: BusinessPartnerRole<T>
  ): UpdateRequestBuilder<BusinessPartnerRole<T>, T>;
}
