 ...
 */
export declare class CustomerSalesAreaTextRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<CustomerSalesAreaText<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<CustomerSalesAreaText<T>, T>;
  /**
   ...
   */
  create(
    entity: CustomerSalesAreaText<T>
  ): CreateRequestBuilder<CustomerSalesAreaText<T>, T>;
  /**
  ...
  update(
    entity: CustomerSalesAreaText<T>
  ): UpdateRequestBuilder<CustomerSalesAreaText<T>, T>;
  /**
  ...
  delete(
    ...
    language: string,
    longTextId: string
  ): DeleteRequestBuilder<CustomerSalesAreaText<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `CustomerSalesAreaText`.
