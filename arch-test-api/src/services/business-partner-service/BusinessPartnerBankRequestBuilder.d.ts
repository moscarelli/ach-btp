 ...
 */
export declare class BusinessPartnerBankRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<BusinessPartnerBank<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<BusinessPartnerBank<T>, T>;
  /**
   ...
   */
  create(
    entity: BusinessPartnerBank<T>
  ): CreateRequestBuilder<BusinessPartnerBank<T>, T>;
  /**
  ...
  update(
    entity: BusinessPartnerBank<T>
  ): UpdateRequestBuilder<BusinessPartnerBank<T>, T>;
  /**
  ...
  ): DeleteRequestBuilder<BusinessPartnerBank<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `BusinessPartnerBank`.
