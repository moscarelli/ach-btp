 ...
 */
export declare class SupplierWithHoldingTaxRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<SupplierWithHoldingTax<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<SupplierWithHoldingTax<T>, T>;
  /**
   ...
   */
  create(
    entity: SupplierWithHoldingTax<T>
  ): CreateRequestBuilder<SupplierWithHoldingTax<T>, T>;
  /**
  ...
  update(
    entity: SupplierWithHoldingTax<T>
  ): UpdateRequestBuilder<SupplierWithHoldingTax<T>, T>;
  /**
  ...
  ): DeleteRequestBuilder<SupplierWithHoldingTax<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `SupplierWithHoldingTax`.
