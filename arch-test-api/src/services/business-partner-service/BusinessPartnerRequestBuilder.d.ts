 ...
 */
export declare class BusinessPartnerRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<BusinessPartner<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<BusinessPartner<T>, T>;
  /**
   ...
   */
  create(
    entity: BusinessPartner<T>
  ): CreateRequestBuilder<BusinessPartner<T>, T>;
  /**
  ...
  update(
    entity: BusinessPartner<T>
  ): UpdateRequestBuilder<BusinessPartner<T>, T>;
}
