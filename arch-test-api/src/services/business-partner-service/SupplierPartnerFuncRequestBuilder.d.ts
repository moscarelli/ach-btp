 ...
 */
export declare class SupplierPartnerFuncRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<SupplierPartnerFunc<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<SupplierPartnerFunc<T>, T>;
  /**
   ...
   */
  create(
    entity: SupplierPartnerFunc<T>
  ): CreateRequestBuilder<SupplierPartnerFunc<T>, T>;
  /**
  ...
  update(
    entity: SupplierPartnerFunc<T>
  ): UpdateRequestBuilder<SupplierPartnerFunc<T>, T>;
  /**
  ...
  ): DeleteRequestBuilder<SupplierPartnerFunc<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `SupplierPartnerFunc`.
