 ...
 */
export declare class CustomerTextRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<CustomerText<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<CustomerText<T>, T>;
  /**
  ...
  delete(
    ...
    language: string,
    longTextId: string
  ): DeleteRequestBuilder<CustomerText<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `CustomerText`.
