 ...
 */
export declare class BusinessPartnerAddressRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<BusinessPartnerAddress<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<BusinessPartnerAddress<T>, T>;
  /**
   ...
   */
  create(
    entity: BusinessPartnerAddress<T>
  ): CreateRequestBuilder<BusinessPartnerAddress<T>, T>;
  /**
  ...
  update(
    entity: BusinessPartnerAddress<T>
  ): UpdateRequestBuilder<BusinessPartnerAddress<T>, T>;
  /**
  ...
  delete(
    ...
    addressId: string
  ): DeleteRequestBuilder<BusinessPartnerAddress<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `BusinessPartnerAddress`.
