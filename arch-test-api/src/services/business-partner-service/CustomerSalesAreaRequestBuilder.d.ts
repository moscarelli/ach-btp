 ...
 */
export declare class CustomerSalesAreaRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<CustomerSalesArea<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<CustomerSalesArea<T>, T>;
  /**
   ...
   */
  create(
    entity: CustomerSalesArea<T>
  ): CreateRequestBuilder<CustomerSalesArea<T>, T>;
  /**
  ...
  update(
    entity: CustomerSalesArea<T>
  ): UpdateRequestBuilder<CustomerSalesArea<T>, T>;
}
