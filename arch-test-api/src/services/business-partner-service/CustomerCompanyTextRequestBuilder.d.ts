 ...
 */
export declare class CustomerCompanyTextRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<CustomerCompanyText<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<CustomerCompanyText<T>, T>;
  /**
   ...
   */
  create(
    entity: CustomerCompanyText<T>
  ): CreateRequestBuilder<CustomerCompanyText<T>, T>;
  /**
  ...
  update(
    entity: CustomerCompanyText<T>
  ): UpdateRequestBuilder<CustomerCompanyText<T>, T>;
  /**
  ...
  delete(
    ...
    language: string,
    longTextId: string
  ): DeleteRequestBuilder<CustomerCompanyText<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `CustomerCompanyText`.
