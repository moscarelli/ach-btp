 ...
 */
export declare class AddressEmailAddressRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<AddressEmailAddress<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<AddressEmailAddress<T>, T>;
  /**
   ...
   */
  create(
    entity: AddressEmailAddress<T>
  ): CreateRequestBuilder<AddressEmailAddress<T>, T>;
  /**
  ...
  update(
    entity: AddressEmailAddress<T>
  ): UpdateRequestBuilder<AddressEmailAddress<T>, T>;
  /**
  ...
  ): DeleteRequestBuilder<AddressEmailAddress<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `AddressEmailAddress`.
