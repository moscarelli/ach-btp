 ...
 */
export declare class BuPaIdentificationRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<BuPaIdentification<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<BuPaIdentification<T>, T>;
  /**
   ...
   */
  create(
    entity: BuPaIdentification<T>
  ): CreateRequestBuilder<BuPaIdentification<T>, T>;
  /**
  ...
  update(
    entity: BuPaIdentification<T>
  ): UpdateRequestBuilder<BuPaIdentification<T>, T>;
  /**
  ...
  ): DeleteRequestBuilder<BuPaIdentification<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `BuPaIdentification`.
