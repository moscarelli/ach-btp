 ...
 */
export declare class BuPaIndustryRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<BuPaIndustry<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<BuPaIndustry<T>, T>;
  /**
  ...
  ): DeleteRequestBuilder<BuPaIndustry<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `BuPaIndustry`.
