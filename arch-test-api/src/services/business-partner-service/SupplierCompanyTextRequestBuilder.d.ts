 ...
 */
export declare class SupplierCompanyTextRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<SupplierCompanyText<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<SupplierCompanyText<T>, T>;
  /**
   ...
   */
  create(
    entity: SupplierCompanyText<T>
  ): CreateRequestBuilder<SupplierCompanyText<T>, T>;
  /**
  ...
  update(
    entity: SupplierCompanyText<T>
  ): UpdateRequestBuilder<SupplierCompanyText<T>, T>;
  /**
  ...
  delete(
    ...
    language: string,
    longTextId: string
  ): DeleteRequestBuilder<SupplierCompanyText<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `SupplierCompanyText`.
