...
export class CustomerCompanyTextApi<
  DeSerializersT extends DeSerializers = DefaultDeSerializers
> implements EntityApi<CustomerCompanyText<DeSerializersT>, DeSerializersT>
{
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<CustomerCompanyText<DeSerializersT>, DeSerializersT>(
      this
    );
  }
  ...
  private _schema?: {
    CUSTOMER: OrderableEdmTypeField<
      CustomerCompanyText<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      false,
      true
