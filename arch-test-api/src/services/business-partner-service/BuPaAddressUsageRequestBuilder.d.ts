 ...
 */
export declare class BuPaAddressUsageRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<BuPaAddressUsage<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<BuPaAddressUsage<T>, T>;
  /**
   ...
   */
  create(
    entity: BuPaAddressUsage<T>
  ): CreateRequestBuilder<BuPaAddressUsage<T>, T>;
  /**
  ...
  update(
    entity: BuPaAddressUsage<T>
  ): UpdateRequestBuilder<BuPaAddressUsage<T>, T>;
  /**
  ...
  delete(
    ...
    addressUsage: string,
    addressId: string
  ): DeleteRequestBuilder<BuPaAddressUsage<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `BuPaAddressUsage`.
