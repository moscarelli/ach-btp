 ...
 */
export declare class SupplierPurchasingOrgTextRequestBuilder<
  T extends DeSerializers = DefaultDeSerializers
> extends RequestBuilder<SupplierPurchasingOrgText<T>, T> {
  /**
  ...
  ): GetByKeyRequestBuilder<SupplierPurchasingOrgText<T>, T>;
  /**
   ...
   */
  create(
    entity: SupplierPurchasingOrgText<T>
  ): CreateRequestBuilder<SupplierPurchasingOrgText<T>, T>;
  /**
  ...
  update(
    entity: SupplierPurchasingOrgText<T>
  ): UpdateRequestBuilder<SupplierPurchasingOrgText<T>, T>;
  /**
  ...
  delete(
    ...
    language: string,
    longTextId: string
  ): DeleteRequestBuilder<SupplierPurchasingOrgText<T>, T>;
  /**
   * Returns a request builder for deleting an entity of type `SupplierPurchasingOrgText`.
